...
const Triangle = function () {
    ...
    let triangleVerts = [
     // X, Y              R   G    B
      0.5,  0.5,         1.0, 0.0, 0.0,  // Górny prawy wierzchołek
     -0.5,  0.5,         1.0, 0.0, 0.0,  // Górny lewy wierzchołek
     -0.5, -0.5,         1.0, 0.0, 0.0,  // Dolny lewy wierzchołek
      0.5,  0.5,         1.0, 0.0, 0.0,  // Górny prawy wierzchołek
     -0.5, -0.5,         1.0, 0.0, 0.0,  // Dolny lewy wierzchołek
      0.5, -0.5,         1.0, 0.0, 0.0   // Dolny prawy wierzchołek
    ];
