...
const Triangle = function () {
    ...
    const colorButton = document.getElementById('myButton');
    colorButton.addEventListener('click', changeTriangleColor);
...
function changeTriangleColor() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        let offsetForColor = 2 + i * 5; // w buforze numeracja od zera!!!

        triangleVerts[offsetForColor] = newColor[0];     // R
        triangleVerts[offsetForColor + 1] = newColor[1]; // G
        triangleVerts[offsetForColor + 2] = newColor[2]; // B
